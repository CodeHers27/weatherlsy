...
export const updateWeather=function(lat,lon){
   loading.style.display="grid";
        ...
        fetchData(url.airPollution(lat,lon),function(airPollution){
            ...
            <div class="card card-sm highlight-card">
                ...
                <div class="wrapper">
                    ...
                    <p class="title-1">
                        ${parseInt(feels_like)}&deg;<sub>c</sub>
                    </p>
                </div>
            </div>
         </div>`;
    ...
    width="48" height="48" loading="lazy" alt="${description}" class="weather-icon" title="${description}" >
    ...
    <div class="card card-sm slider-card">
                                ...
                                width="48" height="48" loading="lazy" alt="direction" class="weather-icon" style="transform:rotate(${windDirection-180}deg)>
